 ...
 */
public class TelaCadastroComic extends javax.swing.JFrame {
    
    TelaLogin login = new TelaLogin();
    TelaComics comics = new TelaComics();

    /**
     * Creates new form TelaCadastroComic
     */
    public TelaCadastroComic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(501, 501, 501)
                .addComponent(nomeComicjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        ...
        ComicDAO comicDao = new ComicDAO(login.getDataSource());
         if (!titulojTextField.getText().equals("")){
             ...
             comics.lista.clear();
             comics.povoarLista();
             JOptionPane.showMessageDialog(null, "Comic salva com sucesso!");
             dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroComic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroComic().setVisible(true);
            }
        });
    }
