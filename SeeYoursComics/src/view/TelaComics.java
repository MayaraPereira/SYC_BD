 ...
 */
public class TelaComics extends javax.swing.JFrame {
    ...
    private void editarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarjButtonActionPerformed
        // TODO add your handling code here:
        System.out.println(comicsjList.getSelectedIndex());
        if (comicsjList.getSelectedIndex() != -1) {
            System.out.println(getLista().get(comicsjList.getSelectedIndex()).getId());
            setRevistaEdit(getLista().get(comicsjList.getSelectedIndex()).getId());
            TelaEditarComic form = new TelaEditarComic();
            dispose();
    ...
    private void excluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirjButtonActionPerformed
        ...
        if (comicsjList.getSelectedIndex() != -1) {
            ...
            comicDao.remove(getLista().get(comicsjList.getSelectedIndex()));
    ...
    private void cadastrarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarjButtonActionPerformed
        // TODO add your handling code here:
        TelaAddComic form = new TelaAddComic();
        dispose();
        form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaComics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaComics().setVisible(true);
            }
        });
    }
    ...
    /**
     * @return the revistaEdit
     */
    public int getRevistaEdit() {
        return revistaEdit;
    }

    /**
     * @param revistaEdit the revistaEdit to set
     */
    public void setRevistaEdit(int revistaEdit) {
        this.revistaEdit = revistaEdit;
    }
