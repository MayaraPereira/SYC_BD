 ...
 */
public class TelaAddLoan extends javax.swing.JFrame {
    
    private ArrayList<Comic> lista = new ArrayList<Comic>();
    private static int revistaEdit;
    private TelaLogin login = new TelaLogin();
    DefaultListModel modelo;
    /**
     * Creates new form TelaAddLoan
     */
    public TelaAddLoan() {
        initComponents();
    ...
    public void povoarLista(){
        ...
        try {
            ...
            while (rs.next()){
                if (login.getId_user() == (rs.getInt("id_user")) && (rs.getBoolean("statusEmprestimo") == false)){
            ...
            if (getLista().size() == 0 && rs.next() == false){
                JOptionPane.showMessageDialog(null, "Nenhuma Revista Disponivel");
    ...
    private void initComponents() {
        ...
        nomeLoanjLabel.setText("New Loan");
        ...
        jScrollPane1.setViewportView(comicsjList);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(520, 520, 520)
                .addComponent(nomeLoanjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        ...
        if (!nomeSolicitantejTextField.getText().equals("") && comicsjList.getSelectedIndex() != -1){
            ComicDAO comicDao = new ComicDAO(login.getDataSource());
            comicDao.atualizarDadosEmprestimo(getLista().get(comicsjList.getSelectedIndex()).getId(), getLista().get(comicsjList.getSelectedIndex()).getTitulo(), getLista().get(comicsjList.getSelectedIndex()).getEdicao(), getLista().get(comicsjList.getSelectedIndex()).getSuperheroi(), getLista().get(comicsjList.getSelectedIndex()).getPreco(), true);
            //getLista().get(comicsjList.getSelectedIndex()).setStatusEmprestimo(true);
            System.out.println(login.getId_user());
            loanDao.adicionarDados(dataDevolucaojTextField.getText(), nomeSolicitantejTextField.getText(), getLista().get(comicsjList.getSelectedIndex()).getId(), login.getId_user());
            TelaLoans loan = new TelaLoans();
            loan.modelo.clear();
            loan.getLista().clear();
            loan.povoarLista();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAddLoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAddLoan().setVisible(true);
            }
        });
    }
